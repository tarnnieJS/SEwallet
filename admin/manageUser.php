            ...
            <div class="content">
              <form action="saveUser.php" method="POST">
                <div class="field">
                  ...
                  <div class="control">
                    <input required name="user_id" class="input" type="text" placeholder="User ID"  class="input" type="text" name="user_id" maxlength="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  />
                  </div>
                </div>
                ...
                <div class="field">
                  ...
                  <div class="control">
                    <div class="select">
                      <select name="class">
                        <option>Admin ปี1</option>
                        <option>Admin ปี2</option>
                        <option>Admin ปี3</option>
                        <option>Admin ปี4</option>
                      </select>
                    </div>
                  </div>
                </div>
